...
#Makes The Quiz Randomly Choose Between Addition, Subtraction, Division, Multiplication
...
def submitAnswer():
    ...
    question_count += 1
    if question_count < 10:  #10 questions per difficulty
        displayProblem()
    else:
        displayResults()
...
title_label = Label(root, text="MATH QUIZ", font=("Arial", 25, "bold"), bg="lightblue", fg="#333")
title_label.pack(pady=40)
...
question_label = Label(root, text="", font=("Arial", 20), bg="lightblue")
...
result_label = Label(root, text="", font=("Arial", 20), bg="lightblue")
